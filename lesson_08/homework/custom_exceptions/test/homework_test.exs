defmodule CustomExceptionsTest do
  ...
  test "get_from_list!" do
    ...
    assert_raise IndexOutOfBoundsError, "index 4 is out of bounds [0-4)", fn ->
      get_from_list!(list, 4)
    end

    assert_raise IndexOutOfBoundsError, "index -1 is out of bounds [0-4)", fn ->
      get_from_list!(list, -1)
    end

    assert_raise IndexOutOfBoundsError, "index 42 is out of bounds [0-4)", fn ->
  ...
  test "get_many_from_list!" do
    ...
    assert_raise IndexOutOfBoundsError, "index 5 is out of bounds [0-5)", fn ->
      get_many_from_list!(list, [0, 1, 5])
    end

    assert_raise IndexOutOfBoundsError, "index 10 is out of bounds [0-5)", fn ->
